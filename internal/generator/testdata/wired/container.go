...
import (
	...
	"example.com/testapp/internal/features/userprofile"
)
...
type Container struct {
	// UserProfile handles HTTP requests for the user-profile feature.
...
func New() *Container {
	...
	userprofileRepo := userprofile.NewInMemoryRepository()
	userprofileService := userprofile.NewService(userprofileRepo)
	c.UserProfile = userprofile.NewHandler(userprofileService, c.Logger)
